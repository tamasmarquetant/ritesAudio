...
public sealed class ObjectPool : MonoBehaviour
{
	...
	// List of possible VGO prefabs the Eventlistener scripts can refer to 
	...
	void Awake()
	{
				try {
						...
						if (startupPoolMode == StartupPoolMode.Awake) {
								...
								foreach (GameObject o in Resources.LoadAll("AudioObjects",typeof(GameObject))) {
										prefabList.Add (o);
								}
						}
				} catch {
						Debug.Log ("Probal uj Objectpoolt letrehozni");
				}
		}
	...
	public static GameObject Spawn(GameObject prefab, Transform parent, Vector3 position, Quaternion rotation)
	{
		...
		Transform trans;
		GameObject obj;
//		Debug.Log ( "GameObject "+ prefab+ "Transform " + parent + "Vector3 " + position + "Quaternion " + rotation	);
